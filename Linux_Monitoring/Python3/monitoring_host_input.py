...
Usage : python monitoring.py -s host1,host2
"""
...
strTo = "sunil.narhe@allscripts.com"
strFrom = "root@dc1-lnxmgmt01.allscripts.lan"
...
"""
HTML_END = """<p><br/><h4>Note:</h4>1. Memory measure in MB<br/>2. Disk threshold is 80% (NA means no Alert)</p>
<p><br/><br/> <br />
Regards,<br/>
Unix Team.<br/>
Email: Sunil Narhe</p>
